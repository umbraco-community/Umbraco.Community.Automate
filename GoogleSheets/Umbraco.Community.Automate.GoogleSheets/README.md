...
Supports `Umbraco.Automate` 17.x–18.x (declared range: `[17.0.0, 19.0.0)`). See [CONTRIBUTING.md](../../CONTRIBUTING.md#supporting-multiple-umbraco-versions) for how this range is maintained and when it changes.
