...
description: Manages the Umbraco.Community.Automate demo site for development. Handles starting with DemoSite-Claude profile, port discovery via named pipes, and stopping. Use when starting, stopping, or checking the demo site.
...
Manage the Umbraco.Community.Automate demo site with automatic port discovery via named pipes.
